...
function buildScope(ctx, input, hooks: RuntimeRecord = {}) {
  ...
  const spawnDefaults: RuntimeRecord = {};
  ...
  function normalizeWorkerOpts(opts: RuntimeRecord = {}) {
  ...
  function spawnWorker(prompt, opts: RuntimeRecord = {}) {
  ...
  agent.create = function createAgent(defaults: RuntimeRecord = {}) {
    ...
    return {
      ...
      spawn(prompt, opts: RuntimeRecord = {}) {
        const finalPrompt = prompt || agentDefaults.prompt;
        if (typeof finalPrompt !== "string" || !finalPrompt.trim()) {
  ...
  function loopUntilDry(makePrompt, opts: RuntimeRecord = {}) {
    return engine.loopUntilDry(makePrompt, { ...spawnDefaults, phase: currentPhase, ...opts, ctx });
  }

  function adversarialVerify(findings, opts: RuntimeRecord = {}) {
  ...
  async function fanout(taskOrSpecs, opts: RuntimeRecord = {}) {
...
async function runScript(input: RuntimeRecord = {}) {
